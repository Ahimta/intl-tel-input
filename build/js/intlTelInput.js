        ...
        _initListeners: function() {
            ...
            if (this.isMobile) {
                ...
                $(selectedFlag).on("click" + this.ns, function(e) {
                    ...
                    if (hasClass(that.countryList[0], "hide") && !that.element.disabled && !that.element.readonly) {
                        that._showDropdown();
                    }
                });
            }
